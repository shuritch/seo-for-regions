<h1 align="center">
Улучшаем региональное SEO продвижение веб-сайта
</h1>
...
После 3 месяцев работы данного способа - мы решили подвести итоги. Для этого мы решили сравнить временные отрезки за Октябрь-Декабрь и Январь-Март. Однако, прежде чем смотреть статистику, стоит сказать - на проекте не используется реклама, а также за этот период мы ввели много других улучшений, например: семантическую верстку, микроразметку, оптимизации разных видов и другое.

<p align="right">Октябрь-декабрь</p>
<img src="./assets/oct-dec.jpg" />
<p align="right">Январь-Март</p>
<img src="./assets/jan-mar.jpg" />

Как видно из статистики, количество посетителей из поисковой системы гугла не только сравнялось с посетителями из Яндекса, но и даже обогнало. Такой эффект почти никогда не проявляется при доменном подходе. Однако напомню, эта статистика не показательна и служит лишь показателем конкретного веб-сайта.
